    ...
    return (
        <View style={styles.body}>
            ...
            <TouchableOpacity onPress={goToPrestante} style={{backgroundColor: corAmarela, width: '90%', height: 152, borderRadius: 10, justifyContent: 'center', alignItems: 'center'}}>
                ...
                <View style={{width: '100%', height: 48, backgroundColor:corCinzaPrincipal, alignItems: 'flex-end', justifyContent: 'center', position: 'absolute', bottom: 0, borderBottomLeftRadius: 8, borderBottomRightRadius: 8}}>
